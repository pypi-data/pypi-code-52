...
class AwsEcsDeploy:
    ...
    def prep_task_from_settings_dir(self):
        ...
        self._init_terraform(self.def_dir)
        self._apply_terraform(self.def_dir)
...
if __name__ == '__main__':
    def_dir = '/home/sonhador/projects/bnc/pvp/.deploy'
    settings_file = '/home/sonhador/projects/bnc/pvp/.deploy/code_deploy_settings.json'
    ecs = AwsEcsDeploy(def_dir, settings_file)
    #ecs.prep_task_from_settings_dir()
    ecs.create_deploy()
